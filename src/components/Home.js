...
import TitlesAnimate from './TitlesAnimate';
import TitlesSlowAnimate from './TitlesSlowAnimate';
    ...
    render() {
        ...
        return (
            <div className='container'>
                <div className='flex flex-col md:flex-row m-auto md:m-28 md:ml-8'>
                    ...
                    exit={{ opacity: 0, transition: { duration: 1.5 } }}>
                        <div className='basis-5/12 md:pl-[100px] md:pt-[100px]'>
                            {/* tracking-[10px]  */}
                            <h1 className='mb-12 text-ternary-dark'>DAVYD SADOVSKYY</h1>
                            <div className='mt-40'>
                ...
                <div className='flex flex-col md:flex-row mt-40 mb-32 bg-slate-100 border-solid border-4'>
                    <img src={headshot} className='h-[400px] p-16' />
                    <p className='text-[25px] p-12'>ååååå™™™££££¡™£¢∞§¶•ªº––≠≠≠≠≠≠“‘‘««««««««…æææ………÷÷÷÷÷÷÷≥≥≥≤µ≤≥
                    µµµµ∆∆∆∆˚˚˚¬¬¬˚¬¬¬¬¬¬˚˚¬¬∆∆∆∆∆˙˙˙˙˙˜˜˜∫∫˜˜˜∫∫∫∫∫√çç√ç≈≈≈≈≈≈≈≈≈≈≈≈``````~~~aGOTEEM HA
                    </p>
                </div>
                <SocialProfiles />
            </div>
