...
const Project = props => {
    ...
    return (
        <div className=' relative flex flex-col items-center rounded-2xl w-[37rem] h-[60rem] overflow-hidden'>
            ...
            <hr className="line line:hover" style={{ width: '40rem', fontWeight: 'bold' }} />
        </div>
    )
}
